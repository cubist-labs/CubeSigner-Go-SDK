...
func (client *ApiClient) AuthMigrationUserUpdate(migrateUpdateUsersRequest models.MigrateUpdateUsersRequest) (*models.EmptyImpl, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method: "POST",
		path:   "/v0/org/{org_id}/auth_migration/update_users",
		body:   migrateUpdateUsersRequest,
	})
	if err != nil {
		return nil, err
	}
...
func (client *ApiClient) DiffieHellmanExchange(keyId string, diffieHellmanRequest models.DiffieHellmanRequest, mfaReceipts ...*MfaReceipt) (*CubeSignerResponse[models.DiffieHellmanResponse], error) {
	resp, err := client.send(&payload{
		method:      "POST",
		path:        "/v0/org/{org_id}/diffie_hellman/{key_id}",
		pathParams:  map[string]string{"key_id": keyId},
		body:        diffieHellmanRequest,
		mfaReceipts: mfaReceipts,
	})
	if err != nil {
		return nil, err
	}
	return newCubeSignerResponseFrom[models.DiffieHellmanResponse](resp)
}
...
func SiweInit(env session.EnvInterface, orgId string, siweInitRequest models.SiweInitRequest) (*models.SiweInitResponse, error) {
	client, err := NewApiClient(&noSessionManager{OrgID: orgId, RootUrl: env.Spec.SignerApiRoot})
	if err != nil {
		return nil, err
	}
	resp, err := client.sendAndAssertNoMfa(&payload{
		...
		body:   siweInitRequest,
	})
	if err != nil {
		return nil, err
	}
	return ParseGenericResponseInto[models.SiweInitResponse](resp)
}
...
//	> For this endpoint to succeed, the org must be configured to:
//	> Allow the issuer `https://shim.oauth2.cubist.dev/siwe` with the Org ID as the client ID
func SiweComplete(env session.EnvInterface, orgId string, siweCompleteRequest models.SiweCompleteRequest) (*models.SiweCompleteResponse, error) {
	client, err := NewApiClient(&noSessionManager{OrgID: orgId, RootUrl: env.Spec.SignerApiRoot})
	if err != nil {
		return nil, err
	}
	resp, err := client.sendAndAssertNoMfa(&payload{
		method: "PATCH",
		path:   "/v0/org/{org_id}/oidc/siwe",
		body:   siweCompleteRequest,
	})
	if err != nil {
		return nil, err
	}
	return ParseGenericResponseInto[models.SiweCompleteResponse](resp)
}
...
func (client *ApiClient) GetRoleKey(roleId string, keyId string, queryParameters *models.GetRoleKeyParams) (*models.KeyInRoleInfo, error) {
	queryParams := make(map[string]string)
	if queryParameters != nil {
		if queryParameters.Details != nil {
			detailsStr := fmt.Sprintf("%v", *queryParameters.Details)
			queryParams["details"] = detailsStr
		}
	}
	resp, err := client.sendAndAssertNoMfa(&payload{
		method:      "GET",
...
func (client *ApiClient) UserResetEmailInit(emailResetRequest models.EmailResetRequest) (*models.EmailOtpResponse, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method: "POST",
...
func (client *ApiClient) UserResetEmailComplete(emailOtpAnswer models.EmailOtpAnswer) (*models.EmptyImpl, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method: "PATCH",
		path:   "/v0/org/{org_id}/user/me/email",
		body:   emailOtpAnswer,
...
func (client *ApiClient) ListUsersInOrg(queryParameters *models.ListUsersInOrgParams) (*models.PaginatedGetUsersInOrgResponse, error) {
	...
	if queryParameters != nil {
		...
		if queryParameters.Q != nil {
			queryParams["q"] = *queryParameters.Q
		}
	}
	resp, err := client.sendAndAssertNoMfa(&payload{
		method:      "GET",
...
func (client *ApiClient) GetUserInOrgByEmail(email string) (*models.GetUserByEmailResponse, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method:     "GET",
		path:       "/v0/org/{org_id}/users/email/{email}",
		pathParams: map[string]string{"email": email},
	})
	if err != nil {
		return nil, err
	}
	return ParseGenericResponseInto[models.GetUserByEmailResponse](resp)
}
...
func (client *ApiClient) GetUserInOrgByOidc(iss string, sub string) (*models.GetUserByOidcResponse, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method:     "GET",
		path:       "/v0/org/{org_id}/users/oidc/{iss}/{sub}",
		pathParams: map[string]string{"iss": iss, "sub": sub},
	})
	if err != nil {
		return nil, err
	}
	return ParseGenericResponseInto[models.GetUserByOidcResponse](resp)
}

// Initialize MFA reset for user
func (client *ApiClient) ResetMemberMfa(mfaResetRequest models.MfaResetRequest) (*models.EmptyImpl, error) {
	resp, err := client.sendAndAssertNoMfa(&payload{
		method: "POST",
...
func CompleteResetMemberMfa(env session.EnvInterface, orgId string, idToken string, completeMfaResetRequest models.CompleteMfaResetRequest) (*models.EmptyImpl, error) {
	client, err := NewApiClient(&noSessionManager{OrgID: orgId, RootUrl: env.Spec.SignerApiRoot})
	if err != nil {
		return nil, err
	}
